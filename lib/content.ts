...
export const US_PLANS: Plan[] = [
  {
    ...
    price: "$99",
    per: "/month",
    sub: "Your family in India, fully covered",
    features: [
      "Dedicated family manager + WhatsApp group",
      "Unlimited tasks for your parents in India",
      "Emergency response - our concierge on the ground with your family",
      "Cyber-fraud cover - insurance up to ₹20L, monitoring & education",
      "$10/mo wellness credits - tests, physio & more",
    ],
    highlight: false,
  },
  {
    ...
    price: "$169",
    per: "/month",
    sub: "Both sides of your family's life",
    lead: "Everything in Niro India, plus",
    features: [
      "Your US household admin handled too",
      "Home repairs & vendor coordination - quotes, scheduling, follow-up",
      "DMV, registration, inspections & vehicle admin",
      "Kids' camps, school forms & activity signups",
      "Subscriptions, refunds, warranty claims & insurance chasing",
    ],
    highlight: true,
    badge: "Both sides",
  },
