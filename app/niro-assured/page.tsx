...
/**
 * /niro-assured - the emergency response protocol, with numbers.
 *
...
export const metadata: Metadata = {
  title: "Niro Assured - our emergency response protocol",
  description:
  ...
  alternates: { canonical: "https://tellniro.com/niro-assured" },
};
  ...
  return (
    <PageShell>
      <article className="prose">
        <p className="assured-mark">Niro Assured</p>
